...
export default function StudentSupportPage() {
  ...
  const pageSteps = [
    ...
    },
    {
      ...
      targetId: "section-nss",
    },
    {
      name: "Computer Based Test (CBT) Facilities",
      fields: [
        "cbt-conducted",
        "cbt-capacity",
      ],
      targetId: "section-cbt",
    },
  ];
            ...
            <div className="flex-1 space-y-6">
              ...
              <section id="section-ncc" className="rounded-2xl border border-border/70 bg-muted/40 p-5 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {renderSelectField(values, setValue, "ncc-available", "NCC Unit Available?", ["Yes", "No"])}
                  {renderSelectField(values, setValue, "ncc-year", "Academic Year", ["2023-24", "2022-23"])}
                  {renderInputField(values, setValue, "ncc-male", "Institution Students (Male)", undefined, "number")}
                  {renderInputField(values, setValue, "ncc-female", "Institution Students (Female)", undefined, "number")}
              ...
              <section id="section-nss" className="rounded-2xl border border-border/70 bg-muted/40 p-5 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {renderSelectField(values, setValue, "nss-available", "NSS Available?", ["Yes", "No"])}
                  {renderSelectField(values, setValue, "nss-year", "Academic Year", ["2023-24", "2022-23"])}
