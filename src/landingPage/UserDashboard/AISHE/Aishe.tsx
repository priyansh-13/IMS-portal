...
import {
  ...
  DollarSign, Globe, Mail, KeyRound, LogOut, Menu, ChevronRight, User, Smartphone,
} from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col bg-gray-100" style={{ fontSize: "13px" }}>
      ...
      <div className="text-white text-[13px] py-0 px-0 flex items-stretch shadow-lg z-10 min-h-[36px]" style={{ backgroundColor: BRAND }}>
        ...
        <span className="px-4 py-2 border-r border-white/20 shrink-0 flex items-center">User Role :
          <br />University Nodal Officer</span>
        <span className="px-4 py-2 border-r border-white/20 shrink-0 flex items-center">U-0167</span>
        <span className="px-4 py-2 border-r border-white/20 flex items-center font-medium tracking-wide flex-1 min-w-0">Maharshi Dayanand University, Rohtak</span>
